# bus_stop_simulation_sourcecode
...
void man2()
{
	...
	glColor3ub(0,0,0);
	glBegin(GL_LINES);
 		glVertex2i(540-320,495+76);
 		glVertex2i(540-320,490+76); //nose
  		glVertex2i(531-320,500+76);
 		glVertex2i(537-320,500+76);//eyebrow
  		glVertex2i(543-320,500+76);
 		glVertex2i(549-320,500+76);//eyebrow
 	glEnd();
//ear right
	glBegin(GL_POLYGON);
	glColor3ub(255,191,128);
	glVertex2i(540-14-320,494+1+76);
	glVertex2i(540-14-320,490+1+76);
	glVertex2i(538-14-320,489+1+76);
	glVertex2i(538-14-320,495+1+76);
	glEnd();
	//ear left
	glBegin(GL_POLYGON);
	glColor3ub(255,191,128);
	glVertex2i(554-320,495+76);
	glVertex2i(556-320,496+76);
	glVertex2i(556-320,491+76);
	glVertex2i(554-320,490+76);
	glEnd();
//hair
	glBegin(GL_POLYGON);
	  glColor3ub(0,0,0);
	  glVertex2i(527-320,503+76);
	  glVertex2i(553-320,503+76);
	  glVertex2i(547-320,509+76);
	  glVertex2i(533-320,509+76);
	glEnd();


	// eyes
 	glBegin(GL_POLYGON);
 		glVertex2i(533-320,498+76);
 		glVertex2i(535-320,498+76);
 		glVertex2i(535-320,496+76);
 		glVertex2i(533-320,496+76);
glEnd();
glBegin(GL_POLYGON);
 		glVertex2i(545-320,498+76);
 		glVertex2i(547-320,498+76);
 		glVertex2i(547-320,496+76);
 		glVertex2i(545-320,496+76);
glEnd();
 	// mouth
glBegin(GL_POLYGON);
 		glVertex2i(535-320,487+76);
 		glVertex2i(540-320,485+76);
 		glVertex2i(545-320,487+76);
 		glVertex2i(540-320,487+76);
glEnd();
//beard
glBegin(GL_POLYGON);
    glColor3ub(0,0,0);
    glVertex2i(538-320,480+76);
	glVertex2i(542-320,480+76);
	glVertex2i(542-320,484+76);
	glVertex2i(538-320,484+76);
glEnd();
//shirt
 	glBegin(GL_POLYGON);
 		glColor3ub(55,50,70);
	    	glVertex2i(529-320,480+76);
 		glVertex2i(551-320,480+76);
 		glVertex2i(566-320,469+76);
 		glVertex2i(561-320,461+76);
 		glVertex2i(556-320,465+76);
        	glVertex2i(556-320,445+76);
 		glVertex2i(524-320,445+76);
 		glVertex2i(524-320,465+76);
 		glVertex2i(519-320,460+76);
 		glVertex2i(514-320,469+76);
glEnd();
//hands
 	glBegin(GL_POLYGON);
		glColor3ub(255,191,128);
 		glVertex2i(565-320,468+76);
 		glVertex2i(575-320,453+76);
 		glVertex2i(567-320,454+76);
 		glVertex2i(562-320,462+76);
 	glEnd();
  	glBegin(GL_POLYGON);
		glVertex2i(575-320,453+76);
 		glVertex2i(556-320,438+76);
 		glVertex2i(556-320,445+76);
 		glVertex2i(567-320,454+76);
 	glEnd();
glBegin(GL_POLYGON);
	 	glVertex2i(515-320,468+76);
 		glVertex2i(505-320,453+76);
 		glVertex2i(513-320,454+76);
 		glVertex2i(518-320,462+76);
 	glEnd();
  	glBegin(GL_POLYGON);
		glVertex2i(505-320,453+76);
   		glVertex2i(524-320,438+76);
   		glVertex2i(524-320,445+76);
   		glVertex2i(513-320,454+76);
  	glEnd();
// belt
 	glBegin(GL_POLYGON);
		glColor3ub(150,12,30);
 		glVertex2i(556-320,445+76);
 		glVertex2i(524-320,445+76);
 		glVertex2i(524-320,440+76);
		glVertex2i(524-320,440+76);

 		glVertex2i(556-320,440+76);
glEnd();
// collar
 	glBegin(GL_POLYGON);
		glColor3ub(200,140,110+76);
 		glVertex2i(529-320,480+76);
 		glVertex2i(551-320,480+76);
 		glVertex2i(546-320,470+76);
 		glVertex2i(534-320,470+76);
glEnd();

 	glBegin(GL_TRIANGLES);
		glColor3ub(20,140,110);
 		glVertex2i(540-320,477+76);
  		glVertex2i(545-320,470+76);
 		glVertex2i(535-320,470+76);
glEnd();

// buttons
	glColor3ub(0,0,0);
	glPushMatrix();
	glTranslatef(540-320,465+76,0);
	glutSolidTorus(1,1,100,90);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(540-320,458+76,0);
	glutSolidTorus(1,1,100,90);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(540-320,451+76,0);
	glutSolidTorus(1,1,100,90);
	glPopMatrix();
...
glBegin(GL_POLYGON);
		glColor3ub(80,80,230);
glVertex2i(555-320,440+76);
glVertex2i(525-320,440+76);
glVertex2i(520-320,405+76);
glVertex2i(530-320,405+76);
glVertex2i(533-320,438+76);
glVertex2i(550-320,405+76);
glVertex2i(560-320,405+76);
	glEnd();
		//shoe left
	glBegin(GL_POLYGON);
	glColor3ub(100,10,10);
	glVertex2i(530-320,405+76);
	glVertex2i(530-320,396+76);
	glVertex2i(512-320,396+76);
	glVertex2i(520-320,405+76);
	...
	glColor3ub(100,10,10);
	glVertex2i(550-320,405+76);
	glVertex2i(550-320,396+76);
	glVertex2i(568-320,396+76);
	glVertex2i(560-320,405+76);
	glEnd();
